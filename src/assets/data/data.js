...
export const data = [
  {
    ...
    fossils: [
      {
        fossilTitle:
          'Triarthrus eatoni (Ovo de trilobita) (Ordoviciano Superior 450 - 440 Ma)',
        image: img1,
        details: {
          reconstruction: rec1,
          longDescription:
      ...
      {
        fossilTitle:
          'Ovo de peixe Actinistia (mesma ordem do celacanto) (Carbonífero 359 - 299 Ma)',
        image: img2,
        details: {
          longDescription:
            'Lorem ipsum dolor sit amet consectetur, adipisicing elit. Provident dolore a aperiam illo soluta ullam quaerat incidunt, deleniti doloremque laborum eveniet similique tempora itaque veniam consequuntur. Totam atque impedit molestias!',
  ...
  },
  {
    title: 'Mesozóico',
    description:
      'Lorem ipsum dolor sit amet consectetur adipisicing elit. Vel fugiat, facere, commodi mollitia laudantium quas molestiae quos itaque, voluptatem amet pariatur laboriosam minima dolor id impedit? Aliquid voluptatem odit exercitationem.',
    fossils: [
      {
        fossilTitle:
